      ...
      if (res.status !== 200) {
        ...
        for(var i=0; i<len;i++){
            ...
            for (var j = 0; j < sugflen; j++) {
                ...
                if(res.data[i].sugar[j].bloodGlucoseF !=0 || res.data[i].sugar[j].bloodGlucoseF !=""){
                    sumsugf += parseInt(res.data[i].sugar[j].bloodGlucoseF);
                    countsugf++;  
                }

                if(res.data[i].sugar[j].bloodGlucosePP!=0 || res.data[i].sugar[j].bloodGlucosePP !=""){
            ...
            for (var k = 0; k < bloodcountlen; k++) {
                ...
                if(res.data[i].bloodCount[k].platelateCount !=0 || res.data[i].bloodCount[k].platelateCount!=""){
                    sumplatelet += parseInt(res.data[i].bloodCount[k].platelateCount);
                    countplatelet++;  
                }

                if(res.data[i].bloodCount[k].hemoglobin!=0 || res.data[i].bloodCount[k].hemoglobin!=" "){
                    sumhg += parseInt(res.data[i].bloodCount[k].hemoglobin);
                    counthg++;  
                }

                if(res.data[i].bloodCount[k].rbcCount!=0 || res.data[i].bloodCount[k].rbcCount!=" "){
        ...
        lineChartCtn &&
          ...
          var barChart,barChartoptions={
              ...
              series:[{name:"Sugar Tests",
              data:num_sugar_tests},

              {name:"Blood Count Tests",data: num_blood_count_tests}],

              chart:{type:"bar",height:350,stacked:!0,columnWidth:"70%",
              zoom:{enabled:!1},toolbar:{enabled:!1}},theme:{mode:colors.chartTheme},
              ...
              xaxis:{categories:category,
                ...
                labels:{show:!0,trim:!1,minHeight:void 0,maxHeight:120,style:{colors:colors.mutedColor,cssClass:"text-muted",
                fontFamily:base.defaultFontFamily}},axisBorder:{show:!1}},

                yaxis:{labels:{show:!0,trim:!1,offsetX:-5,minHeight:void 0,maxHeight:120,

                    style:{colors:colors.mutedColor,cssClass:"text-muted",fontFamily:base.defaultFontFamily}}},

                    legend:{position:"bottom",fontFamily:base.defaultFontFamily,fontWeight:400,
                    
                    labels:{colors:colors.mutedColor,useSeriesColors:!1},offsetY:10,
                    markers:{width:10,height:10,strokeWidth:0,strokeColor:colors.borderColor,
                        fillColors:chartColors,radius:6,customHTML:void 0,onClick:void 0,offsetX:0,offsetY:0},
                        itemMargin:{horizontal:10,vertical:0},onItemClick:{toggleDataSeries:!0},onItemHover:{highlightDataSeries:!0}},
                        fill:{opacity:1,colors:chartColors},grid:{show:!0,borderColor:colors.borderColor,strokeDashArray:0,
                            position:"back",xaxis:{lines:{show:!0}},yaxis:{lines:{show:!1}},row:{colors:void 0,opacity:.5},
                            column:{colors:void 0,opacity:.5},padding:{top:0,right:0,bottom:0,left:10}}},
